 ...
 * @param [in] args Arguments passed to the ActionRegion action handler.
 */
 ...
 * @param [in] instrPanel InstructionsPanel to draw on.
 */
 ...
 * @param [in] instrPanel InstructionsPanel to draw.
 */
 ...
 * @param [in] instrPanel InstructionsPanel to add to.
 */
