...
typedef struct {
    ...
    /// @private
    /// @brief Cairo surface for pencil button - natural state.
    cairo_surface_t* pencil_button_surface_natural;

    /// @private
    /// @brief Cairo surface for pencil button - selected state.
    cairo_surface_t* pencil_button_surface_selected;

    /// @private
    /// @brief Cairo surface for eraser button - natural state.
    cairo_surface_t* eraser_button_surface_natural;

    /// @private
    /// @brief Cairo surface for eraser button - selected state.
    cairo_surface_t* eraser_button_surface_selected;

    /// @private
    /// @brief Cairo surface for dropper button - natural state.
    cairo_surface_t* dropper_button_surface_natural;

    /// @private
    /// @brief Cairo surface for dropper button - selected state.
    cairo_surface_t* dropper_button_surface_selected;

    /// @private
    /// @brief Cairo surface for select button - natural state.
    cairo_surface_t* select_button_surface_natural;

    /// @private
    /// @brief Cairo surface for select button - selected state.
    cairo_surface_t* select_button_surface_selected;

    /// @private
    /// @brief Cairo surface for stamp button - natural state.
    cairo_surface_t* stamp_button_surface_natural;

    /// @private
    /// @brief Cairo surface for stamp button - selected state.
    cairo_surface_t* stamp_button_surface_selected;

    /// @private
    /// @brief Cairo surface for move button - natural state.
    cairo_surface_t* move_button_surface_natural;

    /// @private
    /// @brief Cairo surface for move button - selected state.
